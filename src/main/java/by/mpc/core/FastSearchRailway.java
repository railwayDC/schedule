 ...
 *
 */
public class FastSearchRailway {
	...
	public FastSearchRailway(ListRoute listRoute, Calendar dateTime, ListCheck check, ListCorrect correct) {
		this(dateTime, check, correct);
		this.listRoute = listRoute;
	}
	
	public FastSearchRailway(Calendar dateTime, ListCheck check, ListCorrect correct) {
